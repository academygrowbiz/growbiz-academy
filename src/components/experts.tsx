      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {experts.map((expert) => (
            <div
              key={expert.name}
              className="group flex flex-col items-center rounded-[20px] border border-white/[0.08] bg-white/[0.03] px-5 pb-6 pt-8 text-center transition-all duration-300 hover:-translate-y-1 hover:border-[#7C3AED]/30 hover:bg-[#7C3AED]/[0.04] hover:shadow-[0_8px_30px_rgba(124,58,237,0.12)]"
            >
              {/* Avatar */}
